...
ERROR_KEYWORDS = {
    ("declare_gazepoint_external_dataset", "invalid_label"): ["label", "required"],
    ("declare_gazepoint_external_dataset", "invalid_independent"): ["independent", "true", "false"],
    ("declare_gazepoint_external_dataset", "missing_identifier"): ["identifier", "not present"],
    ("create_external_validation_report", "invalid_validation"): ["evaluate_external_validation"],
    ("write_external_validation_report", "overwrite_rejected"): ["file exists"],
    ("evaluate_gazepoint_external_transportability", "missing_declaration"): [
        "gp3ml_external_dataset_declaration"
    ],
    ("evaluate_gazepoint_external_transportability", "invalid_model"): [
        "fitted gp3ml model"
    ],
    ("validate_gazepoint_transportability", "invalid_object"): [
        "gp3ml_transportability_report"
    ],
    ("write_gazepoint_transportability_report", "overwrite_rejected"): ["file exists"],
    ("write_gazepoint_transportability_report", "invalid_object"): [
        "gp3ml_transportability_report"
    ],
}
...
def main() -> int:
    if len(sys.argv) != 6:
        raise SystemExit(
            "Usage: python parity/compare_external_validation.py "
