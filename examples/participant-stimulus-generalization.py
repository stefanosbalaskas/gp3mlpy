...
task = gp.create_gazepoint_synthetic_task(data, workflow="recording_quality", generalization_target="new_participants_and_new_stimuli")
assert task.generalization_target == "new_participants_and_new_stimuli"
