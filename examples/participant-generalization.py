...
task = gp.create_gazepoint_synthetic_task(data, workflow="recording_quality", generalization_target="new_participants")
assert task.generalization_target == "new_participants"
