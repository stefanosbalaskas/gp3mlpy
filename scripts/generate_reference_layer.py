...
# Article pages preserve source prose while replacing executable R chunks with Python companions.
...
# Runnable article companions: every source vignette gets an executable Python smoke companion.
